...
export const rawMuiTheme = {
  palette: {
    primary: {
      light: colors.reactionBlueHover,
      main: colors.reactionBlue,
      dark: colors.reactionBlueActive
    }
  },
  typography: {
  ...
  shadows: [
    ...
    "0 5px 10px 0 rgba(0, 0, 0, 0.05);", // "0px 2px 4px -1px rgba(0,0,0,0.2),0px 4px 5px 0px rgba(0,0,0,0.14),0px 1px 10px 0px rgba(0,0,0,0.12)",
