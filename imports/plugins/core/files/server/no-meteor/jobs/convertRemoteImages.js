 ...
 * @return {undefined}
 */
export default function convertRemoteImages(remoteUrlWorker) {
  const convertImagesJob = Jobs.processJobs("convertImage/remote", {
