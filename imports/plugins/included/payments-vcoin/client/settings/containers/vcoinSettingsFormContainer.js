...
import { VCoinSettingsForm } from "../components";

class VCoinSettingsFormContainer extends Component {
  constructor(props) {
    super(props);
...
VCoinSettingsFormContainer.propTypes = {
...
export default composeWithTracker(composer)(VCoinSettingsFormContainer);
