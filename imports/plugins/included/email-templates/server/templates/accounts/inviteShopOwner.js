            ...
            <td align="center" valign="top"><table width="480" class="wrap1001" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td align="left" valign="top" style="font-family: 'Lato', sans-serif; font-size:13px; font-weight:bold; line-height:18px; color:#4d4d4d; letter-spacing: -0.5px;">
                      You’ve been invited by <span style="font-weight:bold;">{{shopName}}</span> to manage a store. Click below to configure your store and start adding products.
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="left" valign="top" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:normal; line-height:17px;">
                      You received this email because {{shopName}} invited you to manage a store. Questions and suggestions? Email us at
                      <a href="mailto:{{contactEmail}}" style="text-decoration:none; color:#1e98d5;">{{contactEmail}}</a>
                    </td>
                  </tr>
                  <!-- Begin Social Icons -->
