...
import placeOrderWithStripeCardPaymentMutation from "/imports/plugins/included/payments-stripe/server/no-meteor/mutations/placeOrderWithStripeCardPayment";

/**
 * @name "Mutation.placeOrderWithStripeCardPayment"
 * @method
 * @memberof Payments/GraphQL
 * @summary resolver for the placeOrderWithStripeCardPayment GraphQL mutation
 ...
 * @return {Promise<Object>} PlaceOrderWithStripeCardPaymentPayload
 */
export default async function placeOrderWithStripeCardPayment(parentResult, { input }, context) {
