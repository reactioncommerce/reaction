...
share.loadFixtures = ->
  ...
  unless Shops.find().count()
    ...
    Shops.insert
      ...
      domains: ["localhost", "reaction.meteor.com", "demo.reactioncommerce.com"]
      email: "admin@ongoworks.com"
      currency: "USD"
    ...
    Products.insert
      ...
      variants: [
        ...
        }
        {
          ...
          metafields: [
            {
              createdAt: '2013-10-25T13:52:21-04:00'
              description: null
              id: 915396092
              key: 'warehouse'
              namespace: 'inventory'
              ownerId: 690933842,
              updatedAt: '2013-10-25T13:52:21-04:00'
              value: '25'
              ownerResource: 'shop'
            }
          ]
