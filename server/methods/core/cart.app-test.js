...
//     function () {
//       this.userId = id;
//       console.log("originals: " + JSON.stringify(originals, null, 4));
...
//       spyOn(Collections.Cart._hookAspects.update.after[0], "aspect");
//       spyOn(Collections.Products._hookAspects.remove.after[0], "aspect");
//     }
//
...
//   });
//
//   it("originals should still retain its original values", function () {
//     console.log(originals);
//     spyOnMethod("mergeCart", 1);
//     console.log("New Originals:" + JSON.stringify(originals, null, 4));
//   });
//
//   it("this stupid test should merge all `anonymous` carts into existent `normal` user cart per session, when logged in",
//     function (done) {
//       let anonymousCart = Factory.create("anonymousCart");
//       let cart = Factory.create("cart");
//       spyOn(Meteor.server.method_handlers, "cart/mergeCart", cart.userId, sessionId);
...
//   const sessionId = Reaction.sessionId = Random.id();
//
//   describe("cart/mergeCart", function () {
//     before(function () {
//       // We are mocking inventory hooks, because we don't need them here, but
//       // if you want to do a real stress test, you could try to comment out
//       // this two lines and uncomment the following spyOn line. This is needed
...
//   });
//
//   describe.skip("cart/copyCartToOrder", () => {
//     it(
