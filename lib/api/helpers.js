...
/**
 * getShopId
 * @return {String} returns current shopId, null if not found
 */
...
/**
 * getShopName
 * @return {String} returns current shop name, null if not found
 */
 ...
 * @return {String} returns current shop id, null if not found
 */
export function getSellerShopId(userId = this.userId) {
...
/**
 * getCurrentTag
 * @return {String} returns current tag, null if not found
 */
