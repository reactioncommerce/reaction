...
function getSellerShopId() {
  if (Meteor.isClient) {
    // ideally we want to bring the declaration in here
    // it's there for simplicity and to avoid cyclic redundancy issues
...
const Reaction = {}.assign({}, Core.Reaction, {
  getSellerShopId
});
