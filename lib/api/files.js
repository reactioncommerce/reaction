...
/**
 * @method _copyStoreData
 * @private
 * @memberof Core
 * @summary Copy store data, copied from Meteor CollectionsFS
 * @see https://github.com/CollectionFS/Meteor-CollectionFS/blob/master/packages/file/fsFile-server.js#L225
 */
 ...
 * @method copyFile
 * @memberof Core
 * @summary Modified from Meteor CollectionsFS
 * @example copyFile(fileObj, {productId: newId, variantId: variantNewId })
 * @see https://github.com/CollectionFS/Meteor-CollectionFS/blob/master/packages/file/fsFile-server.js#L126
 */
export function copyFile(fileObj, newMetaData) {
  ...
  for (const name in newFile.copies) {
    if ({}.hasOwnProperty.call(newFile.copies, name)) {
