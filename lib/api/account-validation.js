 ...
 * Methods for validating account username, email and password. Methods are exported globally in the `LoginFormValidation` object and they are also registered as Meteor methods.
 * @namespace Meteor/Accounts/Validation
 */
...
const validationMethods = {
   ...
   * @name username
   * @method
   * @memberof Meteor/Accounts/Validation
   ...
   * @method
   * @memberof Meteor/Accounts/Validation
   * @summary Passwords may be validated 2 ways. 1. "exists" (options.validationLevel = "exists") - Password must not be blank. Thats is the only rule. Used to validate a sign in. 2. undefined (options.validationLevel = undefined) - Password must meet the lenght and other criteria to validate. Used for validating a new sign up.
