 ...
 */
ReactionProduct.getVariants = (id, type) => Catalog.getVariants(id ||
 ...
 */
ReactionProduct.getTopVariants = id => Catalog.getTopVariants(id ||
 ...
 */
ReactionProduct.getTag = () => getCurrentTag() ||
  getShopName().toLowerCase();
