...
import { stateflowTransform } from "./transform/stateflow";
 ...
 */
export const Stateflows = new Mongo.Collection("Stateflows", {
  transform(stateflow) {
    const stateflowExtension = Object.create(stateflowTransform);
    return _.extend(stateflowExtension, stateflow);
  }
});

Stateflows.attachSchema(Schemas.Stateflow);
