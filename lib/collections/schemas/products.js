...
import { shopIdAutoValue, shopDefaultCountry, shopDefaultParcelWeight, shopDefaultParcelLength, shopDefaultParcelWidth,
  shopDefaultParcelHeight } from "./helpers";
...
export const ProductVariant = new SimpleSchema({
  ...
  weight: {
    ...
    optional: true,
    decimal: true,
    autoValue: shopDefaultParcelWeight,
    custom: function () {
      if (Meteor.isClient) {
        if (!(this.siblingField("type").value === "inventory" || this.value ||
          this.value === 0)) {
  ...
  length: {
    ...
    optional: true,
    decimal: true,
    autoValue: shopDefaultParcelLength
  },
  width: {
    label: "Width",
    type: Number,
    ...
    optional: true,
    decimal: true,
    autoValue: shopDefaultParcelWidth
  },
  height: {
    label: "Height",
    type: Number,
    ...
    optional: true,
    decimal: true,
    autoValue: shopDefaultParcelHeight
  },
  inventoryManagement: {
    type: Boolean,
