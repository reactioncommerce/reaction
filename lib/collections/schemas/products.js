 ...
 * @property {Number} index, optional, Variant position number in list. Used for keeping array index, moving variants through list, like drag-n-drop.
 ...
 * @property {Boolean} inventoryPolicy, default value: false, If disabled, an item can be sold even if it not in stock.
 ...
 * @property {Boolean} isLowQuantity, optional, denormalized field, indicates when at least one of variant is lower than `lowInventoryWarningThreshold`
 ...
 * @property {Boolean} isLowQuantity denormalized, Indicates when at least one variant `inventoryQuantity` is lower than `lowInventoryWarningThreshold`
 * @property {Boolean} isSoldOut denormalized, Indicates when all variants `inventoryQuantity` is zero
 * @property {Boolean} isBackorder denormalized, It is `true` if product not in stock, but customers anyway could order it.
