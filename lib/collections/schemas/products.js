...
import { shopIdAutoValue, shopDefaultCountry, shopDefaultParcelSize } from "./helpers";
...
export const ProductVariant = new SimpleSchema({
  ...
  weight: {
    ...
    optional: true,
    decimal: true,
    autoValue: shopDefaultParcelSize.weight,
    custom: function () {
      if (Meteor.isClient) {
        if (!(this.siblingField("type").value === "inventory" || this.value ||
          this.value === 0)) {
  ...
  length: {
    ...
    optional: true,
    decimal: true,
    autoValue: shopDefaultParcelSize.length
  },
  width: {
    label: "Width",
    type: Number,
    ...
    optional: true,
    decimal: true,
    autoValue: shopDefaultParcelSize.width
  },
  height: {
    label: "Height",
    type: Number,
    ...
    optional: true,
    decimal: true,
    autoValue: shopDefaultParcelSize.height
  },
  inventoryManagement: {
    type: Boolean,
