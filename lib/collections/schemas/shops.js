 ...
 */
export const StripeConnectSettings = new SimpleSchema({
  "tokenType": {
    type: String,
    optional: true
  },
...
export const Shop = new SimpleSchema({
  ...
  "defaultSellerRoles": {
    type: [String],
    defaultValue: ["admin", "seller", "guest", "manage-users", "orders", "account/profile", "product", "createProduct", "tag", "index", "cart/checkout", "cart/completed"]
  },
  "layout": {
    type: [Layout],
    optional: true
