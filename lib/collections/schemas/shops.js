 ...
 */
export const DefaultParcelSize = new SimpleSchema({
  weight: {
    type: Number,
    decimal: true,
    defaultValue: 7
...
registerSchema("DefaultParcelSize", DefaultParcelSize);
 ...
 * @property {Object} defaultParcelSize blackbox
 */
