...
export const Shop = new SimpleSchema({
  ...
  "defaultVisitorRole": {
    type: [String],
    defaultValue: ["anonymous", "guest", "product", "account/verify", "tag", "index", "cart/checkout", "cart/completed"]
  },
  "defaultRoles": {
    type: [String],
    defaultValue: ["guest", "account/profile", "product", "account/verify", "tag", "index", "cart/checkout", "cart/completed"]
  },
  "layout": {
    type: [Layout],
    optional: true
