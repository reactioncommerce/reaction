 ...
 * Shop Taxes
 */
export const ShopTaxes = new SimpleSchema({
  "taxesIncluded": {
    type: Boolean,
    optional: true
  },
...
export const Shop = new SimpleSchema({
  ...
  "defaultSellerRoles": {
    type: [String],
    defaultValue: ["admin", "guest", "account/profile", "product", "createProduct", "tag", "index", "cart/checkout", "cart/completed", "manage-users"]
  },
  "layout": {
    type: [Layout],
    optional: true
