...
export const cartOrderTransform = {
  ...
  getShippingTotalByShop() {
    ...
    // to be generated, needs this functionality of getShippingTotalByShop in the first place)
    // So a similar approach to getSubtotalByShop, like the current one, seems okay for now.
    // const billingObject = {};
