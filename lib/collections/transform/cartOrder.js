...
export const cartOrderTransform = {
  ...
  cartCount() {
    Logger.warn("this method has been deprecated and is now replaced by the getCount method");
    return this.getCount();
  },
  cartShipping() {
    Logger.warn("this method has been deprecated and is now replaced by the getShippingTotal method");
    return this.getShippingTotal();
  },
  cartSubTotal() {
    Logger.warn("this method has been deprecated and is now replaced by the getSubtotal method");
    return this.getSubTotal();
  },
  cartTaxes() {
    Logger.warn("this method has been deprecated and is now replaced by the getTaxTotal method");
    return this.getTaxTotal();
  },
  cartDiscounts() {
    Logger.warn("this method has been deprecated and is now replaced by the getDiscounts method");
    return this.getDiscounts();
  },
  cartTotal() {
    Logger.warn("this method has been deprecated and is now replaced by the getTotal method");
