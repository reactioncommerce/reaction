...
export const cartOrderTransform = {
  ...
  cartCount() {
    // TODO: DEPRECATE Remove this method after one version
    Logger.warn("cartCount has been deprecated and is now replaced by the getCount method. Please update your code");
    return this.getCount();
  },
  cartShipping() {
    // TODO: DEPRECATE Remove this method after one version
    Logger.warn("cartShipping has been deprecated and is now replaced by the getShippingTotal method. Please update your code");
    return this.getShippingTotal();
  },
  cartSubTotal() {
    // TODO: DEPRECATE Remove this method after one version
    Logger.warn("cartSubTotal has been deprecated and is now replaced by the getSubtotal method. Please update your code");
    return this.getSubTotal();
  },
  cartTaxes() {
    // TODO: DEPRECATE Remove this method after one version
    Logger.warn("cartTaxes has been deprecated and is now replaced by the getTaxTotal method. Please update your code");
    return this.getTaxTotal();
  },
  cartDiscounts() {
    // TODO: DEPRECATE Remove this method after one version
    Logger.warn("cartDiscount has been deprecated and is now replaced by the getDiscounts method. Please update your code");
    return this.getDiscounts();
  },
  cartTotal() {
    // TODO: DEPRECATE Remove this method after one version
    Logger.warn("cartTotal has been deprecated and is now replaced by the getTotal method. Please update your code");
