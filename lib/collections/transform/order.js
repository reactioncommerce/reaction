...
export const orderTransform = {
  ...
  itemsByShop() {
    ...
    let itemsByShop = _.sortBy(this.items, function (item) {
      return item.shopId;
    });
  ...
  paymentMethods() {
    // Currently we just have the one method, but we will have an array of methods soon, this the plural and array
