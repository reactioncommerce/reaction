!function (a) {
  ...
  function b(a) {return a ? c(a) : void 0}
  ...
  return d.exports = b, b.prototype.on = function (a, b) {
  ...
  }, b.prototype.hasListeners = function (a) {return!!this.listeners(a).length}, function () {
    ...
    e = "undefined" != typeof b && null !== b ? b : require("emitter"), h = function () {}, c = function (a) {
      function b(a, d) {
        var e, f, g;
      ...
      var c;
      return k(b, a), b.prototype.events = [
      ...
      }, b.prototype.removeFile = function (a) {return a.status === b.UPLOADING && this.cancelUpload(a), this.files = i(this.files, a), this.emit("removedfile", a), 0 === this.files.length ? this.emit("reset") : void 0}, b.prototype.removeAllFiles = function (a) {
        var c, d, e, f;
    ...
    }(e), c.version = "3.7.1", c.options = {}, c.optionsForElement = function (a) {return a.id ? c.options[f(a.id)] : void 0}, c.instances =
      [
      ...
      for (document.querySelectorAll ? d = document.querySelectorAll(".dropzone") : (d = [], a = function (a) {
        ...
        return f
      }, a(document.getElementsByTagName("div")), a(document.getElementsByTagName("form"))), g =
      ...
      return f
    }, f = function (a) {return a.replace(/[\-_](\w)/g, function (a) {return a[1].toUpperCase()})}, c.createElement = function (a) {
      var b;
      ...
      return e
    }, c.confirm = function (a, b, c) {return window.confirm(a) ? b() : null != c ? c() : void 0}, c.isValidFile = function (a, b) {
      var c, d, e, f, g;
      if (!b) {
        return!0;
      }
    ...
    }, c._autoDiscoverFunction = function () {return c.autoDiscover ? c.discover() : void 0}, g(window, c._autoDiscoverFunction)
  }.call(this), d.exports
});
