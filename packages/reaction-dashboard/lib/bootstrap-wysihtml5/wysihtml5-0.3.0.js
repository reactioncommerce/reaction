...
rangy.createModule("DomUtil", function (api, module) {
  ...
  if (!util.areHostMethods(el, ["insertBefore", "appendChild", "cloneNode"] || !util.areHostObjects(el, [
  ...
  /** @scope wysihtml5.views.Textarea.prototype */ {
    ...
    _observe: function () {
      var element = this.element,
         ...
         */
          events = wysihtml5.browser.supportsEvent("focusin") ? ["focusin", "focusout", "change"] :
          ["focus", "blur", "change"];
