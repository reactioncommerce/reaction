var tinymce = {majorVersion: '3', minorVersion: '2.1.1', releaseDate: '2008-11-27', _init: function () {
  ...
  s = s || o;
  if (typeof(o.length) != 'undefined') {for (n = 0, l = o.length; n < l; n++) {
    if (cb.call(s, o[n], n, o) === false) {
      return 0;
    }
  }} else {for (n in o) {if (o.hasOwnProperty(n)) {
    if (cb.call(s, o[n], n, o) === false) {
      return 0;
    }
  }}}
  ...
  var o = [];
  tinymce.each(a, function (v) {o.push(f(v));});
  return o;
}, grep: function (a, f) {
  var o = [];
  ...
  return o;
}, trim: function (s) {return(s ? '' + s : '').replace(/^\s*|\s*$/g, '');}, create: function (s, p) {
  ...
  if (s[5]) {
    ...
    scn = s[5].match(/\.(\w+)$/i)[1];
    c = ns[cn];
    if (de) {ns[cn] = function () {return sp[scn].apply(this, arguments);};} else {
      ns[cn] = function () {
        this.parent = sp[scn];
    ...
    t.each(sp, function (f, n) {ns[cn].prototype[n] = sp[n];});
  ...
  t.each(p['static'], function (f, n) {ns[cn][n] = f;});
  if (this.onCreate) {
  ...
  if (!t.unloads) {
    ...
    function fakeUnload() {
      ...
      if (d.readyState == 'interactive') {
        ...
        window.setTimeout(function () {d.detachEvent('onstop', stop);}, 0);
      }
    };
    if (w.attachEvent) {
  ...
  return r;
}, explode: function (s, d) {return s ? tinymce.map(s.split(d || ','), tinymce.trim) : s;}, _addVer: function (u) {
  var v;
  if (!this.query) {
    return u;
  }
...
(function () {
  ...
  tinymce.create('tinymce.util.URI', {URI: function (u, s) {
    ...
    u = /^(?:(?![^:@]+:[^:@\/]*@)([^:\/?#.]+):)?(?:\/\/)?((?:(([^:@]*):?([^:@]*))?@)?([^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/.exec(u);
    each([
      "source", "protocol", "authority", "userInfo", "user", "password", "host", "port", "relative", "path",
...
(function () {
  ...
  tinymce.create('static tinymce.util.Cookie', {getHash: function (n) {
    ...
    var o = '';
    each(v, function (v, k) {o += (!o ? '' : '&') + escape(k) + '=' + escape(v);});
  ...
  }, set: function (n, v, e, p, d, s) {document.cookie = n + "=" + escape(v) + ((e) ? "; expires=" + e.toGMTString() : "") + ((p) ? "; path=" + escape(p) : "") + ((d) ? "; domain=" + d : "") + ((s) ? "; secure" : "");}, remove: function (n, p) {
    var d = new Date();
...
tinymce.create('static tinymce.util.XHR', {send: function (o) {
  ...
  function get(s) {
    x = 0;
    try {x = new ActiveXObject(s);} catch (ex) {}
    return x;
  };
...
(function () {
  ...
  tinymce.create('tinymce.util.JSONRequest', {JSONRequest: function (s) {
    ...
    o.success = function (c, x) {
      c = JSON.parse(c);
      if (typeof(c) == 'undefined') {c = {error: 'JSON Parse error.'};}
      if (c.error) {
    ...
    o.error = function (ty, x) {ecb.call(o.error_scope || o.scope, ty, x);};
...
(function () {
  ...
  tinymce.create('tinymce.dom.DOMUtils', {doc: null, root: null, files: null, listeners: {}, pixelStyles: /^(top|left|bottom|right|width|height|borderWidth)$/, cache: {}, idPattern: /^#[\w]+$/, elmPattern: /^[\w_*]+$/, elmClassPattern: /^([\w_]*)\.([\w_]+)$/, props: {"for": "htmlFor", "class": "className", className: "className", checked: "checked", disabled: "disabled", maxlength: "maxLength", readonly: "readOnly", selected: "selected", value: "value", id: "id", name: "name", type: "type"}, DOMUtils: function (d, s) {
    ...
    if (tinymce.isIE6) {try {d.execCommand('BackgroundImageCache', false, true);} catch (e) {t.cssFlicker = true;}}
      ...
      each(tinymce.explode(pa), function (v) {
        if (!(xp = t.cache[v])) {
          ...
          each(v.split(' '), function (v) {
            ...
            if (v[3]) {each(v[3].split('.'), function (n) {xp += "[@class = '" + n + "' or contains(concat(' ', @class, ' '), ' " + n + " ')]";});}
          });
          t.cache[v] = xp;
        }
    ...
    if (t.settings.strict) {function get(s, n) {return s.getElementsByTagName(n.toLowerCase());};} else {function get(s, n) {return s.getElementsByTagName(n);};}
    ...
    each(pa.split(','), function (v, i) {
      ...
      if (t.elmPattern.test(v)) {
        each(get(s, v), function (n) {collect(n);});
        return;
      }
    ...
    if (this.doc.defaultView && c) {
      na = na.replace(/[A-Z]/g, function (a) {return'-' + a;});
      try {return this.doc.defaultView.getComputedStyle(n, null).getPropertyValue(na);} catch (ex) {return null;}
    }
    na = na.replace(/-(\D)/g, function (a, b) {return b.toUpperCase();});
    if (na == 'float') {
    ...
    return this.run(e, function (e) {
      ...
      switch (n) {
        case"style":
          if (!is(v, 'string')) {
            each(v, function (v, n) {t.setStyle(e, n, v);});
            return;
          }
          if (s.keep_values) {
            if (v && !t._isRes(v)) {
  ...
  }, show: function (e) {return this.setStyle(e, 'display', 'block');}, hide: function (e) {return this.setStyle(e, 'display', 'none');}, isHidden: function (e) {
    e = this.get(e);
    return!e || e.style.display == 'none' || this.getStyle(e, 'display') == 'none';
  }, uniqueId: function (p) {return(!p ? 'mce_' : p) + (this.counter++);}, setHTML: function (e, h) {
    var t = this;
    return this.run(e, function (e) {
      var x, i, nl, n, p, x;
      h = t.processHTML(h);
    ...
    if (/&[^;]+;/.test(s)) {
      ...
      n = e.firstChild;
      v = '';
      if (n) {do {v += n.nodeValue;} while (n.nextSibling);}
      return v || s;
    }
    return s;
  }, encode: function (s) {
    ...
    return this.run(o, function (o) {
      if (k) {each(o.childNodes, function (c) {n.appendChild(c.cloneNode(true));});}
    ...
    function addClasses(s) {
      each(s.imports, function (r) {addClasses(r);});
...
(function () {
  ...
  tinymce.create('static tinymce.dom.Event', {inits: [], events: [
  ...
  }, _remove: function (o, n, f) {if (o) {try {
    if (o.detachEvent) {
...
(function () {
  ...
  tinymce.create('tinymce.dom.Element', {Element: function (id, s) {
    ...
    each([
      'getPos', 'getRect', 'getParent', 'add', 'setStyle', 'getStyle', 'setStyles', 'setAttrib', 'setAttribs',
      'getAttrib', 'addClass', 'removeClass', 'hasClass', 'getOuterHTML', 'setOuterHTML', 'remove', 'show', 'hide',
      'isHidden', 'setHTML', 'get'
    ], function (k) {
      t[k] = function () {
        var a = arguments, o;
        if (tinymce.isOpera) {
          a = [id];
          each(arguments, function (v) {a.push(v);});
        } else {
  ...
  }, on: function (n, f, s) {return tinymce.dom.Event.add(this.id, n, f, s);}, getXY: function () {return{x: parseInt(this.getStyle('left')), y: parseInt(this.getStyle('top'))};}, getSize: function () {
  ...
  }, moveTo: function (x, y) {this.setStyles({left: x, top: y});}, moveBy: function (x, y) {
    var p = this.getXY();
    this.moveTo(p.x + x, p.y + y);
  }, resizeTo: function (w, h) {this.setStyles({width: w, height: h});}, resizeBy: function (w, h) {
    var s = this.getSize();
...
(function () {
  ...
  tinymce.create('tinymce.dom.Selection', {Selection: function (dom, win, serializer) {
    ...
    each([
      'onBeforeSetContent', 'onBeforeGetContent', 'onSetContent', 'onGetContent'
    ], function (e) {t[e] = new tinymce.util.Dispatcher(t);});
    tinymce.addUnload(t.destroy, t);
    ...
    if (e && e.nodeName == 'IMG') {return{scrollX: sx, scrollY: sy};}
    ...
    function first(n) {return n ? d.createTreeWalker(n, NodeFilter.SHOW_TEXT, null, false).nextNode() : null;};
    function last(n) {
      var c, o, w;
      if (!n) {
        return null;
    ...
    if (!isIE) {
      ...
      if (!r.collapsed) {
        ...
        if (r.startContainer == r.endContainer) {if (r.startOffset - r.endOffset < 2) {
...
(function () {
  ...
  }, writeEndElement: function () {this.node = this.node.parentNode;}, writeFullEndElement: function () {
    var t = this, n = t.node;
  ...
  }, writeCDATA: function (v) {this.node.appendChild(this.doc.createCDATA(v));}, writeComment: function (v) {
    if (tinymce.isIE) {
      v = v.replace(/^\-|\-$/g, ' ');
    }
...
(function () {
  tinymce.create('tinymce.dom.StringWriter', {str: null, tags: null, count: 0, settings: null, indent: null, StringWriter: function (s) {
    ...
    this.writeRaw('<!-- ' + v + '-->');
    this.count++;
  }, writeRaw: function (v) {this.str += v;}, encode: function (s) {
  ...
  }, getContent: function () {return this.str;}, _writeAttributesEnd: function (s) {
    if (!this.inAttr) {
      return;
    }
    this.inAttr = false;
...
(function () {
  ...
  tinymce.create('tinymce.dom.Serializer', {Serializer: function (s) {
    ...
    if (tinymce.relaxedDomain && tinymce.isGecko) {t.writer = new tinymce.dom.StringWriter();} else {try {t.writer = new tinymce.dom.XMLWriter();} catch (ex) {t.writer = new tinymce.dom.StringWriter();}}
    ...
    t.dom = s.dom;
    if (s.remove_redundant_brs) {t.onPostProcess.add(function (se, o) {o.content = o.content.replace(/<br \/>(\s*<\/li>)/g, '$1');});}
    ...
    if (s.fix_list_elements) {
      t.onPreProcess.add(function (se, o) {
        ...
        function prevNode(e, n) {
          var a = n.split(','), i;
          while ((e = e.previousSibling) != null) {for (i = 0; i < a.length; i++) {
            if (e.nodeName == a[i]) {
              return e;
            }
          }}
    ...
    if (!s.node_filter || s.node_filter(n)) {
      switch (n.nodeType) {
        case 1:
          ...
          if (ru.padd) {if (hc && (cn = n.firstChild) && cn.nodeType === 1 && n.childNodes.length === 1) {
    ...
    h = h.replace(/\<!--mce:([0-9]+)--\>/g, function (a, b) {return o.items[parseInt(b)];});
    o.items = [];
    return h;
  }, _encode: function (h) {
...
(function () {
  ...
  tinymce.create('tinymce.dom.ScriptLoader', {ScriptLoader: function (s) {
    ...
    this.queue = [];
    this.lookup = {};
  }, isDone: function (u) {return this.lookup[u] ? this.lookup[u].state == 2 : 0;}, markDone: function (u) {this.lookup[u] = {state: 2, url: u};}, add: function (u, cb, s, pr) {
    ...
    function loadScript(u) {
      if (Event.domLoaded || t.settings.strict_mode) {tinymce.util.XHR.send({url: tinymce._addVer(u), error: t.settings.error, async: false, success: function (co) {t.eval(co);}});} else {
        document.write('<script type="text/javascript" src="' + tinymce._addVer(u) + '"></script>');
      }
    };
    if (!tinymce.is(u, 'string')) {
      each(u, function (u) {loadScript(u);});
      if (cb) {
        cb.call(s || t);
      }
    } else {
    ...
    var w = window;
    if (!w.execScript) {try {eval.call(w, co);} catch (ex) {eval(co, w);}} else {
      w.execScript(co);
    }
...
(function () {
  ...
  }, isDisabled: function () {return this.disabled;}, setActive: function (s) {
    if (s != this.active) {
      this.setState('Active', s);
      this.active = s;
    }
  }, isActive: function () {return this.active;}, setState: function (c, s) {
...
tinymce.create('tinymce.ui.Container:tinymce.ui.Control', {Container: function (id, s) {
  ...
  return c;
}, get: function (n) {return this.lookup[n];}});
...
(function () {
  ...
  tinymce.create('tinymce.ui.MenuItem:tinymce.ui.Control', {MenuItem: function (id, s) {
    ...
    this.selected = s;
  }, isSelected: function () {return this.selected;}, postRender: function () {
    var t = this;
    t.parent();
    if (is(t.selected)) {
...
(function () {
  ...
  tinymce.create('tinymce.ui.DropMenu:tinymce.ui.Menu', {DropMenu: function (id, s) {
    ...
    if (!t.rendered) {
      ...
      each(t.items, function (o) {o.postRender();});
    ...
    tb = DOM.add(n, 'tbody');
    each(t.items, function (o) {t._add(tb, o);});
    t.rendered = true;
    return w;
...
(function () {
  ...
  }, getLength: function () {return this.items.length;}, renderHTML: function () {
...
(function () {
  ...
  tinymce.create('tinymce.ui.NativeListBox:tinymce.ui.ListBox', {NativeListBox: function (id, s) {
  ...
  }, setDisabled: function (s) {DOM.get(this.id).disabled = s;}, isDisabled: function () {return DOM.get(this.id).disabled;}, select: function (va) {
    var t = this, fv, f;
    if (va == undefined) {
      return t.selectByIndex(-1);
    }
    ...
    t.items.push(o);
    t.onAdd.dispatch(t, o);
  }, getLength: function () {return DOM.get(this.id).options.length - 1;}, renderHTML: function () {
    var h, t = this;
    h = DOM.createHTML('option', {value: ''}, '-- ' + t.settings.title + ' --');
    each(t.items, function (it) {h += DOM.createHTML('option', {value: it.value}, it.title);});
...
(function () {
  ...
  tinymce.create('tinymce.ui.SplitButton:tinymce.ui.MenuButton', {SplitButton: function (id, s) {
    ...
    var t = this, s = t.settings;
    if (s.onclick) {Event.add(t.id + '_action', 'click', function () {
      if (!t.isDisabled()) {
        s.onclick(t.value);
      }
    });}
...
(function () {
  ...
  tinymce.create('tinymce.AddOnManager', {items: [
  ], urls: {}, lookup: {}, onAdd: new Dispatcher(this), get: function (n) {return this.lookup[n];}, requireLangPack: function (n) {
...
(function () {
  ...
  tinymce.create('static tinymce.EditorManager', {editors: {}, i18n: {}, activeEditor: null, preInit: function () {
    ...
    Event.add(window, 'beforeunload', function (e) {t.onBeforeUnload.dispatch(t, e);});
  }, init: function (s) {
    ...
    Event.add(document, 'init', function () {
      ...
      switch (s.mode) {
        ...
        function hasClass(n, c) {return c.constructor === RegExp ? c.test(n.className) : DOM.hasClass(n, c);};
  ...
  }, get: function (id) {return this.editors[id];}, getInstanceById: function (id) {return this.get(id);}, add: function (e) {
    this.editors[e.id] = e;
    this._setActive(e);
    return e;
  }, remove: function (e) {
    ...
    if (!tinymce.is(p, 'string')) {each(p, function (o, lc) {each(o, function (o, g) {each(o, function (o, k) {
      if (g === 'common') {
        i18n[lc + '.' + k] = o;
      } else {
        i18n[lc + '.' + g + '.' + k] = o;
  ...
  }, _setActive: function (e) {this.selectedInstance = this.activeEditor = e;}});
...
(function () {
  ...
  tinymce.create('tinymce.Editor', {Editor: function (id, s) {
    ...
    t.plugins = {};
    each([
      'onPreInit', 'onBeforeRenderUI', 'onPostRender', 'onInit', 'onRemove', 'onActivate', 'onDeactivate', 'onClick',
      'onEvent', 'onMouseUp', 'onMouseDown', 'onDblClick', 'onKeyDown', 'onKeyUp', 'onKeyPress', 'onContextMenu',
      'onSubmit', 'onReset', 'onPaste', 'onPreProcess', 'onPostProcess', 'onBeforeSetContent', 'onBeforeGetContent',
      'onSetContent', 'onGetContent', 'onLoadContent', 'onSaveContent', 'onNodeChange', 'onChange',
      'onBeforeExecCommand', 'onExecCommand', 'onUndo', 'onRedo', 'onVisualAid', 'onSetProgressState'
    ], function (e) {t[e] = new Dispatcher(t);});
    ...
    if (!Event.domLoaded) {
      Event.add(document, 'init', function () {t.render();});
      return;
    }
    if (!nst) {
    ...
    if (s.encoding == 'xml') {t.onGetContent.add(function (ed, o) {
      if (o.save) {
    ...
    if (s.add_unload_trigger && !s.ask) {t._beforeUnload = tinyMCE.onBeforeUnload.add(function () {
    ...
    t.undoManager.onUndo.add(function (um, l) {return t.onUndo.dispatch(t, l, um);});
    t.undoManager.onRedo.add(function (um, l) {return t.onRedo.dispatch(t, l, um);});
    if (s.custom_undo_redo) {t.onExecCommand.add(function (ed, cmd, ui, val, a) {
    ...
    t.serializer.onPreProcess.add(function (se, o) {return t.onPreProcess.dispatch(t, o, se);});
    t.serializer.onPostProcess.add(function (se, o) {return t.onPostProcess.dispatch(t, o, se);});
    ...
    if (s.convert_newlines_to_brs) {t.onBeforeSetContent.add(function (ed, o) {
      if (o.initial) {
      ...
      t.serializer.attribValueFilter = function (n, v) {
        ...
        if (n == 'class') {
          if (!t.classesRE) {
            ...
            if (cl.length > 0) {
              s = '';
              each(cl, function (o) {s += (s ? '|' : '') + o['class'];});
    ...
    if (s.cleanup_callback) {
      t.onBeforeSetContent.add(function (ed, o) {o.content = t.execCallback('cleanup_callback', 'insert_to_editor', o.content, o);});
    ...
    if (s.save_callback) {t.onGetContent.add(function (ed, o) {
      if (o.save) {
        o.content = t.execCallback('save_callback', t.id, o.content, t.getBody());
      }
    });}
    if (s.handle_event_callback) {t.onEvent.add(function (ed, e, o) {
      if (t.execCallback('handle_event_callback', e, ed, o) === false) {
        Event.cancel(e);
      }
    });}
    t.onSetContent.add(function () {t.addVisual(t.getBody());});
    if (s.padd_empty_editor) {t.onPostProcess.add(function (ed, o) {o.content = o.content.replace(/^(<p[^>]*>(&nbsp;|&#160;|\s|\u00a0|)<\/p>[\r\n]*|<br \/>[\r\n]*)$/, '');});}
    ...
    setTimeout(function () {
      ...
      if (s.content_css) {tinymce.each(explode(s.content_css), function (u) {t.dom.loadCSS(t.documentBaseURI.toAbsolute(u));});}
      if (s.auto_focus) {
        setTimeout(function () {
    ...
    return i18n[c + '.' + s] || s.replace(/{\#([^}]+)\}/g, function (a, b) {return i18n[c + '.' + b] || '{#' + b + '}';});
  }, getLang: function (n, dv) {return EditorManager.i18n[(this.settings.language || 'en') + '.' + n] || (is(dv) ? dv : '{#' + n + '}');}, getParam: function (n, dv, ty) {
    ...
    if (t.initialized) {t.onNodeChange.dispatch(t, o ? o.controlManager || t.controlManager : t.controlManager, isIE && n.ownerDocument != t.getDoc() ? t.getBody() : n, s.isCollapsed(), o);}
  }, addButton: function (n, s) {
    var t = this;
    t.buttons = t.buttons || {};
    t.buttons[n] = s;
  }, addCommand: function (n, f, s) {this.execCommands[n] = {func: f, scope: s || this};}, addQueryStateHandler: function (n, f, s) {this.queryStateCommands[n] = {func: f, scope: s || this};}, addQueryValueHandler: function (n, f, s) {this.queryValueCommands[n] = {func: f, scope: s || this};}, addShortcut: function (pa, desc, cmd_func, sc) {
    var t = this, c;
    ...
    if (is(cmd_func, 'string')) {
      c = cmd_func;
      cmd_func = function () {t.execCommand(c, false, null);};
    }
    if (is(cmd_func, 'object')) {
      c = cmd_func;
      cmd_func = function () {t.execCommand(c[0], c[1], c[2]);};
    }
    ...
    try {return this.getDoc().queryCommandState(c);} catch (ex) {}
    ...
    try {return this.getDoc().queryCommandValue(c);} catch (ex) {}
  }, show: function () {
    var t = this;
  ...
  }, isHidden: function () {return!DOM.isHidden(this.id);}, setProgressState: function (b, ti, o) {
  ...
  }, getBody: function () {return this.bodyElement || this.getDoc().body;}, convertURL: function (u, n, e) {
    var t = this, s = t.settings;
    ...
    function eventHandler(e, o) {
      ...
      if (t.onEvent.dispatch(t, e, o) !== false) {t[lo[e.fakeType || e.type]].dispatch(t, e, o);}
    };
    ...
    Event.add(s.content_editable ? t.getBody() : (isGecko ? t.getDoc() : t.getWin()), 'focus', function (e) {t.focus(true);});
    if (tinymce.isGecko) {
    ...
    if (isGecko) {
      function setOpts() {
        ...
        if (isGecko && !s.readonly) {
          ...
          try {d.execCommand("styleWithCSS", 0, false);} catch (ex) {
            if (!t._isHidden()) {
    ...
    t.onReset.add(function () {t.setContent(t.startContent, {format: 'raw'});});
      ...
      function tabHandler(ed, e) {
        ...
        function find(d) {
          ...
          if (f) {
            ...
            if (d > 0) {for (i = x + 1; i < el.length; i++) {
              if (el[i].type != 'hidden') {
                return el[i];
              }
            }} else {for (i = x - 1; i >= 0; i--) {
              if (el[i].type != 'hidden') {
                return el[i];
              }
            }}
    ...
    if (s.custom_undo_redo) {
      ...
      } else {Event.add(t.getDoc(), 'blur', function () {
    ...
    if (!s.cleanup_on_startup) {t.onSetContent.add(function (ed, o) {
      if (o.initial) {
...
(function () {
  ...
  function isBlock(n) {return/^(H[1-6]|HR|P|DIV|ADDRESS|PRE|FORM|TABLE|OL|UL|TD|CAPTION|BLOCKQUOTE|CENTER|DL|DT|DD|DIR|FIELDSET|NOSCRIPT|NOFRAMES|MENU|ISINDEX|SAMP)$/.test(n.nodeName);};
  tinymce.create('tinymce.EditorCommands', {EditorCommands: function (ed) {this.editor = ed;}, execCommand: function (cmd, ui, val) {
    var t = this, ed = t.editor, f;
    switch (cmd) {
      case'Cut':
      case'Copy':
      case'Paste':
        try {ed.getDoc().execCommand(cmd, ui, val);} catch (ex) {
          if (isGecko) {
    ...
    if (ed.settings.inline_styles && (!this.queryStateInsertUnorderedList() && !this.queryStateInsertOrderedList())) {
      each(this._getSelectedBlocks(), function (e) {d.setStyle(e, 'paddingLeft', (parseInt(e.style.paddingLeft || 0) + iv) + iu);});
      return;
    }
    ed.getDoc().execCommand('Indent', false, null);
    if (isIE) {d.getParent(s.getNode(), function (n) {if (n.nodeName == 'BLOCKQUOTE') {n.dir = n.style.cssText = '';}});}
  }, Outdent: function () {
  ...
  }, mceSetContent: function (u, v) {this.editor.setContent(v);}, mceToggleVisualAid: function () {
    var ed = this.editor;
    ...
    function set(e) {each(v, function (v, k) {ed.dom.setAttrib(e, k, v);});};
    if (!e) {
    ...
    return-1;
  }, _queryState: function (c) {try {return this.editor.getDoc().queryCommandState(c);} catch (ex) {}}, _queryVal: function (c) {try {return this.editor.getDoc().queryCommandValue(c);} catch (ex) {}}, queryValueFontSize: function () {
  ...
  }, mceSetCSSClass: function (u, v) {this.mceSetStyleInfo(0, {command: 'setattrib', name: 'class', value: v});}, getSelectedElement: function () {
    ...
    if (isIE) {
      ...
      function getParent(n) {return dom.getParent(n, function (n) {return n.nodeType == 1;});};
      sc = r.startContainer;
      ec = r.endContainer;
      so = r.startOffset;
      eo = r.endOffset;
    ...
    if ((e = t.getSelectedElement()) && !ed.settings.force_span_wrappers) {
      ...
      each(isWebKit ? dom.select('span') : dom.select('font'), function (n) {
        ...
        if (dom.getAttrib(n, 'face') == '__' || n.style.fontFamily === '__') {
          ...
          set(sp);
          each(n.childNodes, function (n) {sp.appendChild(n.cloneNode(true));});
          dom.replace(sp, n);
        }
      });
    }
    each(dom.select(nn).reverse(), function (n) {
      ...
      if (!dom.getAttrib(n, 'mce_new')) {
        p = dom.getParent(n, function (n) {return n.nodeType == 1 && dom.getAttrib(n, 'mce_new');});
        if (p) {
          dom.remove(n, 1);
        }
      }
    ...
    n = dom.getParent(ed.selection.getStart(), function (n) {return n.nodeType == 1 && n.style.textAlign;});
    if (v == 'full') {
      v = 'justify';
    }
    if (ed.settings.inline_styles) {
    ...
    function set(s) {
      ...
      try {d.execCommand("styleWithCSS", 0, s);} catch (ex) {d.execCommand("useCSS", 0, !s);}
    };
    if (isGecko || isOpera) {
      set(true);
    ...
    function isBlock(n) {return/^(P|DIV|H[1-6]|ADDRESS|BLOCKQUOTE|PRE)$/.test(n.nodeName);};
    bl = dom.getParent(s.getNode(), function (n) {return isBlock(n);});
    if (bl) {
      if ((isIE && isBlock(bl.parentNode)) || bl.nodeName == 'DIV') {
        nb = ed.dom.create(val);
        each(dom.getAttribs(bl), function (v) {dom.setAttrib(nb, v.nodeName, dom.getAttrib(bl, v.nodeName));});
        b = s.getBookmark();
        dom.replace(nb, bl, 1);
        s.moveToBookmark(b);
        ed.nodeChanged();
  ...
  }, mceSelectNode: function (u, v) {this.editor.selection.select(v);}, mceInsertContent: function (ui, val) {this.editor.selection.setContent(val);}, mceInsertRawHTML: function (ui, val) {
    var ed = this.editor;
  ...
  }, queryStateInsertUnorderedList: function () {return this.editor.dom.getParent(this.editor.selection.getNode(), 'UL');}, queryStateInsertOrderedList: function () {return this.editor.dom.getParent(this.editor.selection.getNode(), 'OL');}, queryStatemceBlockQuote: function () {return!!this.editor.dom.getParent(this.editor.selection.getStart(), function (n) {return n.nodeName === 'BLOCKQUOTE';});}, mceBlockQuote: function () {
    ...
    if (bq = getBQ(sb)) {
      ...
      for (i = nl.length - 1; i >= 0; i--) {dom.insertAfter(nl[i], bq);}
    ...
    function replaceFonts() {
      ...
      each(dom.select(na), function (n) {
        if (n.getAttribute('_mce_new')) {
          function removeStyle(n) {
            if (n.nodeType == 1) {
              each(at.style, function (v, k) {dom.setStyle(n, k, '');});
              if (at['class'] && n.className && op) {each(op.check_classes, function (c) {
                if (dom.hasClass(n, c)) {
                  dom.removeClass(n, c);
                }
              });}
          ...
          dom.getParent(n.parentNode, function (pn) {
            if (pn.nodeType == 1) {
              ...
              if (at['class'] && pn.className && op) {each(op.check_classes, function (c) {
      ...
      each(dom.select(na).reverse(), function (n) {
        var c = 0;
        each(dom.getAttribs(n), function (an) {if (an.nodeName.substring(0, 1) != '_' && dom.getAttrib(n, an.nodeName) != '') {c++;}});
        if (c == 0) {
          dom.remove(n, 1);
        }
      });
    ...
    if (ed.selection.isCollapsed()) {
      ...
      t._applyInlineStyle.chandler = ed.onSetContent.add(function () {delete t._pendingStyles;});
...
tinymce.create('tinymce.UndoManager', {index: 0, data: null, typing: 0, UndoManager: function (ed) {
  ...
  t.typing = 0;
  t.add({initial: true});
}, hasUndo: function () {return this.index != 0 || this.typing;}, hasRedo: function () {return this.index < this.data.length - 1;}});
(function () {
  ...
  tinymce.create('tinymce.ForceBlocks', {ForceBlocks: function (ed) {
    ...
    if (!isIE && s.force_p_newlines) {
      ed.onKeyPress.add(function (ed, e) {if (e.keyCode == 13 && !e.shiftKey) {
        if (!t.insertPara(e)) {
          Event.cancel(e);
        }
      }});
      if (isGecko) {ed.onKeyDown.add(function (ed, e) {
    ...
    function ren(rn, na) {
      ...
      each(rn.childNodes, function (n) {ne.appendChild(n.cloneNode(true));});
      rn.parentNode.replaceChild(ne, rn);
      return ne;
    };
    if (isIE && s.element != 'P') {
      ed.onKeyPress.add(function (ed, e) {t.lastElm = ed.selection.getNode().nodeName;});
    ...
    try {ra.setEndAfter(ec);} catch (ex) {}
    ra.setStart(en, eo);
    aft.appendChild(ra.cloneContents() || d.createTextNode(''));
    r = d.createRange();
    if (!sc.previousSibling && sc.parentNode.nodeName == bn) {r.setStartBefore(sc.parentNode);} else {
    ...
    aft.normalize();
    bef.normalize();
    function first(n) {return d.createTreeWalker(n, NodeFilter.SHOW_TEXT, null, false).nextNode() || n;};
    r = d.createRange();
    ...
    ch = aft.clientHeight;
    if (y < vp.y || y + ch > vp.y + vp.h) {ed.getWin().scrollTo(0, y < vp.y ? y : y - vp.h + 25);}
    return false;
    ...
    window.setTimeout(function () {Event._remove(b, 'DOMNodeInserted', handler);}, 1);
  }});
})();
(function () {
  ...
  tinymce.create('tinymce.ControlManager', {ControlManager: function (ed, s) {
    ...
    t._cls = {};
    t.onPostRender.add(function () {each(t.controls, function (c) {c.postRender();});});
  }, get: function (id) {return this.controls[this.prefix + id] || this.controls[id];}, setActive: function (id, s) {
    var c = null;
    if (c = this.get(id)) {
      c.setActive(s);
    }
    ...
    c.onAddItem.add(function (c, o) {
      ...
      if (!s.onclick) {s.onclick = function (v) {ed.execCommand(s.cmd, s.ui || false, s.value);};}
    });
    ed.onRemove.add(function () {c.destroy();});
    if (tinymce.isIE) {
      c.onShowMenu.add(function () {bm = ed.selection.getBookmark(1);});
    ...
    if (tinymce.isWebKit) {
      c.onPostRender.add(function (c, n) {
        Event.add(n, 'mousedown', function () {ed.bookmark = ed.selection.getBookmark('simple');});
    ...
    s.scope = s.scope || ed;
    if (!s.onclick && !s.menu_button) {s.onclick = function () {ed.execCommand(s.cmd, s.ui || false, s.value);};}
    ...
    s.title = ed.translate(s.title);
    s.scope = s.scope || ed;
    if (!s.onclick) {s.onclick = function (v) {ed.execCommand(s.cmd, s.ui || false, v || s.value);};}
    if (!s.onselect) {s.onselect = function (v) {ed.execCommand(s.cmd, s.ui || false, v || s.value);};}
    s = extend({title: s.title, 'class': 'mce_' + id, scope: s.scope, control_manager: t}, s);
    id = t.prefix + id;
    ...
    return new cls();
  }, setControlType: function (n, c) {return this._cls[n.toLowerCase()] = c;}, destroy: function () {
    each(this.controls, function (c) {c.destroy();});
    this.controls = null;
  }});
})();
(function () {
  ...
  tinymce.create('tinymce.WindowManager', {WindowManager: function (ed) {
    ...
    if (cb)cb.call(s || t);
  }, _decode: function (s) {return tinymce.DOM.decode(s).replace(/\\n/g, '\n');}});
}());
