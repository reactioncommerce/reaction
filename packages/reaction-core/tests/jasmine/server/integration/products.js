...
describe("core product methods", function() {
  ...
  describe("products/updateVariant", function() {
    ...
    it("should update individual variant by admin passing in full object", function(done) {
      var product, updatedProduct, updatedVariant, variant;
      spyOn(Roles, "userIsInRole").and.returnValue(true);
      product = Factory.create("product");
    ...
    return it("should update individual variant by admin passing in partial object", function(done) {
      var product, updatedProduct, updatedVariant, variant;
      spyOn(Roles, "userIsInRole").and.returnValue(true);
      product = Factory.create("product");
      variant = product.variants[0];
  ...
  describe("products/updateVariants", function() {
    ...
    return it("should update all variants by admin passing in array of objects", function(done) {
  ...
  describe("products/deleteVariant", function() {
    ...
    return it("should delete all child variants (options) by admin", function(done) {
      var product;
      spyOn(Roles, "userIsInRole").and.returnValue(true);
      product = Factory.create("product");
  ...
  describe("products/createInventoryVariant", function() {
    ...
    it("should create default barcode inventory variant by admin", function(done) {
      var inventoryVariant, product, variant;
      spyOn(Roles, "userIsInRole").and.returnValue(true);
      product = Factory.create("product");
      variant = product.variants[0];
      expect(_.size(product.variants)).toEqual(1);
    ...
    return it("should create specific barcode inventory variant by admin", function(done) {
      var inventoryVariant, inventoryVariantOptions, product, variant;
      spyOn(Roles, "userIsInRole").and.returnValue(true);
      product = Factory.create("product");
      variant = product.variants[0];
  ...
  describe("products/createInventoryVariants", function() {
    ...
    it("should create default inventory variants by admin", function(done) {
      var inventoryVariant, product, qty, variant;
      spyOn(Roles, "userIsInRole").and.returnValue(true);
      product = Factory.create("product");
      variant = product.variants[0];
      qty = _.random(1, 100);
    ...
    return it("should create inventory variants with prefix by admin", function(done) {
      var initialQty, inventoryVariant, optionVariant, optionVariantId, product, productVariant, qty, variant;
      spyOn(Roles, "userIsInRole").and.returnValue(true);
      product = Factory.create("product");
  ...
  describe("updateProductTags", function() {
    ...
    it("should add new tag when passed tag name and null ID by admin", function(done) {
      var newTag, product, tag, tagName;
      spyOn(Roles, "userIsInRole").and.returnValue(true);
      product = Factory.create("product");
      tagName = "Product Tag";
      newTag = {
    ...
    return it("should add existing tag when passed existing tag and tag._id by admin", function(done) {
      var product, tag;
      spyOn(Roles, "userIsInRole").and.returnValue(true);
      product = Factory.create("product");
  ...
  describe("setHandleTag", function() {
    ...
    return it("should set handle tag for product by admin", function(done) {
      var product, tag;
      spyOn(Roles, "userIsInRole").and.returnValue(true);
      product = Factory.create("product");
      tag = Factory.create("tag");
  ...
  return describe("publishProduct", function() {
    ...
    return it("should not publish product when missing variant", function(done) {
      var isVisible, product;
      spyOn(Roles, "userIsInRole").and.returnValue(true);
      product = Factory.create("product");
      isVisible = product.isVisible;
