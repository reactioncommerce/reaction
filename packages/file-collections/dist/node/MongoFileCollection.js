...
class MongoFileCollection extends _FileCollection.default {
  ...
  constructor(name, options = {}) {
    const { collection, makeNewStringID } = options,opts = (0, _objectWithoutProperties2.default)(options, _excluded);
  ...
  }}exports.default = MongoFileCollection;