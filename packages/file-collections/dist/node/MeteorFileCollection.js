...
class MeteorFileCollection extends _FileCollection.default {
  ...
  constructor(name, options) {
    const { allowInsert, allowUpdate, allowRemove, check, collection, DDP } = options,opts = (0, _objectWithoutProperties2.default)(options, _excluded);
    ...
    this.insertPromise = _util.default.promisify(this.rawCollection.insert.bind(this.rawCollection));
    this.updatePromise = _util.default.promisify(this.rawCollection.update.bind(this.rawCollection));
    this.removePromise = _util.default.promisify(this.rawCollection.remove.bind(this.rawCollection));
