/*
/opt/reaction/src/imports/node-app/core/util/waitReplica.js
   3:1   warning  Missing JSDoc comment                                require-jsdoc
   8:1   warning  Missing JSDoc comment                                require-jsdoc
  12:1   warning  Missing JSDoc comment                                require-jsdoc
  33:1   warning  Missing JSDoc comment                                require-jsdoc
  34:22  error    Expected parentheses around arrow function argument  arrow-parens
  37:1   warning  Missing JSDoc comment                                require-jsdoc
  39:3   warning  Missing JSDoc comment                                require-jsdoc
  65:5   error    Unary operator '++' used                             no-plusplus
  67:16  error    Unexpected `await` inside a loop                     no-await-in-loop
  70:7   error    Unexpected `await` inside a loop                     no-await-in-loop
  78:5   error    Unexpected `await` inside a loop                     no-await-in-loop
