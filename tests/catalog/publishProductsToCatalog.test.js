/**
 * @todo: nedb doesn't provide all the current mongodb method to porperly test this integration
 * Looking into a better mock db replacment. (possible replacment: https://github.com/nodkz/mongodb-memory-server)
 */
