...
describe("waitForReplica.checkWaitRetry", () => {
  it("should work in immediate success case", async () => {
    const outLog = [];
  ...
  it("should work for timeout case with 1 progress dot", async () => {
    const outLog = [];
    function out(message) {
      outLog.push(message);
    }
  ...
  it("should retry until success before first progress dot", async () => {
    const outLog = [];
    function out(message) {
      outLog.push(message);
    }
  ...
  it("should retry until success with progress dots", async () => {
    const outLog = [];
    function out(message) {
      outLog.push(message);
    }
