...
export default async function groupQuery(context, id) {
  ...
  if (context.userHasPermission("reaction:legacy:accounts", "read", { shopId: group.shopId, legacyRoles: ["owner", "admin", "reaction-accounts"] })) return group; // TODO(pod-auth): update this permissions check
